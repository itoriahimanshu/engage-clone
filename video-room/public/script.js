...
navigator.mediaDevices.getUserMedia({
  ...
  socket.on("createMessage", message => {
    $("ul").append(`<li class="message" style=" color:black; font-family:verdana;"><i class="material-icons">create</i>
    ${message}</li><br/>`);
    scrollToBottom()
  })
})
/// putting screen sharing into a button
...
const screenshare = () => {navigator.mediaDevices.getDisplayMedia({
  ...
  // });
  // socket.on("createMessage", message => {
  //   $("ul").append(`<li class="message"><b>user2</b><br/>${message}</li>`);
  //   scrollToBottom()
  // })
})
}
